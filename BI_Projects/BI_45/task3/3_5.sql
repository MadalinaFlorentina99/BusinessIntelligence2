...
select Country, EXTRACT(Year FROM fsi.OrderDate) as 'Year', EXTRACT(Month FROM fsi.OrderDate) as Month,SUM(fsi.OrderLineShoppingCost) AS "Shipping costs" 
from fact_internetsales fsi join dim_location loc 
